...
"connect-src 'self' https://theadvenjo.online https://*.theadvenjo.online https://*.solana.com https://api.mainnet-beta.solana.com wss://*.solana.com https://mainnet.helius-rpc.com https://*.helius-rpc.com https://*.helius.dev wss://*.helius-rpc.com https://*.jup.ag http://localhost:3000 http://localhost:3001 ws://localhost:3001 wss://localhost:3001 https://*.onrender.com wss://*.onrender.com",  "frame-src 'self' https://*.solana.com https://pump.fun https://*.solflare.com",
  "object-src 'none'",
  "base-uri 'self'",
  "form-action 'self'",
];
