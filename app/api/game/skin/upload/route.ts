...
export async function POST(req: NextRequest) {
    ...
    const rl = await checkRateLimit(`game:skin:upload:${user.userId}`, {
        maxAttempts: 10,
        windowMs: 60_000,
        prefix: "api:game:skin:upload",
    });
    ...
    try {
        ...
        const blob = await put(`skins/${user.userId}/${Date.now()}.png`, buffer, {
            access: "public",
        ...
        console.error("[game/skin/upload] Error:", error);
