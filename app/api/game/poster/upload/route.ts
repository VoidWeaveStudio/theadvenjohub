...
export async function POST(req: NextRequest) {
    ...
    const rl = await checkRateLimit(`game:poster:upload:${user.userId}`, {
        maxAttempts: 20,
        windowMs: 60_000,
        prefix: "api:game:poster:upload",
    });
    ...
    try {
        ...
        const blob = await put(`posters/${user.userId}/${Date.now()}.png`, buffer, {
            access: "public",
        ...
        console.error("[game/poster/upload] Error:", error);
