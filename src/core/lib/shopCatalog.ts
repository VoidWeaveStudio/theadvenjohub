...
export const SHOP_CATALOG: ShopCatalogEntry[] = [
    ...
    { itemId: "wif_hat", name: "Dogwifhat", nameKey: "g.cosmetic.wif_hat.name", kind: "cosmetic", description: "Accessory", descriptionKey: "g.shopItem.accessory", defaultCurrency: "ash", defaultPriceAsh: 1, defaultPriceTnj: 0, defaultPriceUsdCents: 0, maxOwned: 1 },
