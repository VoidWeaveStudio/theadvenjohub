    ...
    const options = [
        {
            ...
            title: "Token Gates — my bubble",
            subtitle: "Drop back into the galaxy beside your own bubble",
            action: onGoToOwnBubble,
        },
        {
            icon: <Sparkles className="w-5 h-5 text-[#7FE6CF]" />,
            title: "Token Gates — the Keeper",
            subtitle: "Return to the platform in the Keeper's hands",
            action: onGoToKeeper,
        },
        {
            icon: <Castle className="w-5 h-5 text-[#E8A33D]" />,
            title: "Main Hall",
            subtitle: "The usual crystal route back to the tower",
        ...
        <div className="absolute inset-0 bg-[rgba(6,6,8,0.85)] backdrop-blur-sm flex items-center justify-center z-50 pointer-events-auto font-oxanium p-4">
            <div className="w-full max-w-md bg-[rgba(10,12,20,0.95)] border-2 border-[#66CCFF]/35 rounded-[16px] p-6 shadow-[0_0_35px_rgba(102,204,255,0.15)]">
                <div className="flex items-center justify-between mb-4">
                    <h2 className="text-xl font-black text-[#E5E7EB]">Where to?</h2>
