// src/features/game/ui/TradeInvitePopup.tsx
"use client";
...
export function TradeInvitePopup({ invite, onRespond }: TradeInvitePopupProps) {
    ...
    return (
        <div className="absolute inset-0 bg-[rgba(6,6,8,0.85)] backdrop-blur-sm flex items-center justify-center z-50 pointer-events-auto p-2 sm:p-4">
            <div className="w-full max-w-sm bg-[rgba(12,14,16,0.95)] border-2 border-[#4FD1FF]/40 rounded-[16px] p-6 shadow-[0_0_35px_rgba(79,209,255,0.15)]">
                ...
                <p className="text-[#C9CDD3] text-sm mb-6">
                    <span className="text-[#E5E7EB] font-bold">{invite.fromNickname}</span> wants to trade with you.
                </p>
