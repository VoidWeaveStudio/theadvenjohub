...
import { CELL_SIZE, LEVEL_HEIGHT, SPAWN_BEACON_PIECE, STORAGE_CRATE_PIECE, FACTION_TURRET_PIECE } from "@/core/lib/roomLayoutGrid";
...
function factionTurretParts(): BuildPart[] {
    const stone: THREE.BufferGeometry[] = [
        cylinder(0.62, 0.78, 0.28, 8, 0, 0.14, 0),
        box(1.02, 0.12, 1.02, 0, 0.34, 0),
    ];

    const metal: THREE.BufferGeometry[] = [
        cylinder(0.3, 0.42, 0.72, 8, 0, 0.76, 0),
        box(0.72, 0.44, 0.66, 0, 1.34, 0),
        box(0.2, 0.24, 0.2, 0, 1.66, 0),
    ];

    for (const dx of [-0.2, 0.2]) {
        metal.push(cylinder(0.08, 0.08, 0.92, 6, dx, 1.34, 0.5));
    }

    for (let i = 0; i < 4; i++) {
        const angle = (i / 4) * Math.PI * 2 + Math.PI / 4;
        metal.push(box(0.14, 0.34, 0.14, Math.cos(angle) * 0.5, 0.5, Math.sin(angle) * 0.5));
    }

    const glow: THREE.BufferGeometry[] = [
        box(0.5, 0.09, 0.05, 0, 1.44, 0.34),
        cylinder(0.09, 0.09, 0.06, 6, 0, 1.74, 0),
    ];

    for (const dx of [-0.2, 0.2]) {
        glow.push(cylinder(0.05, 0.05, 0.06, 6, dx, 1.34, 0.98));
    }
...
const ENTRIES: BuildEntry[] = [
    { id: "floor-plank", name: "g.build.item.floor-plank", icon: "🪵", category: "structure", slot: "tile", layer: "floor", blocking: false, walkableTop: 0.12, build: () => slab("plank", 0.12, 0) },
    { id: "floor-parquet", name: "g.build.item.floor-parquet", icon: "🟫", category: "structure", slot: "tile", layer: "floor", blocking: false, walkableTop: 0.12, build: () => slab("parquet", 0.12, 0) },
    { id: "floor-marble", name: "g.build.item.floor-marble", icon: "⬜", category: "structure", slot: "tile", layer: "floor", blocking: false, walkableTop: 0.12, build: () => pavedSlab("marble", 0.1, "stone") },
    { id: "floor-stone", name: "g.build.item.floor-stone", icon: "🪨", category: "structure", slot: "tile", layer: "floor", blocking: false, walkableTop: 0.12, build: () => pavedSlab("stone", 0.1, "concrete") },
    { id: "floor-concrete", name: "g.build.item.floor-concrete", icon: "🔲", category: "structure", slot: "tile", layer: "floor", blocking: false, walkableTop: 0.12, build: () => slab("concrete", 0.12, 0) },

    { id: "wall-plaster", name: "g.build.item.wall-plaster", icon: "🧱", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [part("plaster", [wallBody(LEVEL_HEIGHT, 0)]), wallTrim("plank", LEVEL_HEIGHT)] },
    { id: "wall-brick", name: "g.build.item.wall-brick", icon: "🟥", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [part("brick", [wallBody(LEVEL_HEIGHT, 0)]), wallTrim("concrete", LEVEL_HEIGHT)] },
    { id: "wall-stone", name: "g.build.item.wall-stone", icon: "⬛", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [part("stone", [wallBody(LEVEL_HEIGHT, 0)])] },
    { id: "wall-plank", name: "g.build.item.wall-plank", icon: "🪧", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [part("plank", [wallBody(LEVEL_HEIGHT, 0)]), wallTrim("plank", LEVEL_HEIGHT)] },
    { id: "wall-half", name: "g.build.item.wall-half", icon: "▂", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, blockHeight: LEVEL_HEIGHT * 0.45, build: () => [part("plaster", [wallBody(LEVEL_HEIGHT * 0.45, 0)]), part("plank", [box(CELL_SIZE, 0.09, WALL_THICKNESS * 1.6, 0, LEVEL_HEIGHT * 0.45, -HALF + WALL_THICKNESS / 2)])] },
    { id: "railing", name: "g.build.item.railing", icon: "🛡️", category: "structure", slot: "edge", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.1, build: railingParts },
    { id: "pillar", name: "g.build.item.pillar", icon: "🏛️", category: "structure", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockRadius: 0.42, build: pillarParts },
    { id: "ceiling", name: "g.build.item.ceiling", icon: "⬛", category: "structure", slot: "tile", layer: "ceiling", blocking: false, walkableTop: LEVEL_HEIGHT, build: () => slab("plaster", 0.14, LEVEL_HEIGHT - 0.14) },
    { id: "stairs", name: "g.build.item.stairs", icon: "🪜", category: "structure", slot: "tile", layer: "stairs", blocking: false, walkableTop: LEVEL_HEIGHT, ramp: true, build: () => stairParts("plank", "metal") },
    { id: "stairs-stone", name: "g.build.item.stairs-stone", icon: "🧗", category: "structure", slot: "tile", layer: "stairs", blocking: false, walkableTop: LEVEL_HEIGHT, ramp: true, build: () => stairParts("stone", "metal") },

    { id: "door", name: "g.build.item.door", icon: "🚪", category: "openings", slot: "edge", layer: "floor", blocking: true, walkableTop: null, hinged: true, opening: { width: 1.4, bottom: 0, top: 2.2 }, build: () => [...wallWithHole("plaster", 1.4, 0, 2.2), part("plank", frame(1.5, 0, 2.3, 0.1))] },
    { id: "arch", name: "g.build.item.arch", icon: "⛩️", category: "openings", slot: "edge", layer: "floor", blocking: true, walkableTop: null, opening: { width: 1.6, bottom: 0, top: 2.45 }, build: () => wallWithHole("plaster", 1.6, 0, 2.45) },
    { id: "window", name: "g.build.item.window", icon: "🪟", category: "openings", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [...wallWithHole("plaster", 1.2, 0.9, 2.2), part("plank", [...frame(1.3, 0.85, 2.25, 0.1), box(1.36, 0.07, 0.34, 0, 0.88, -HALF + WALL_THICKNESS), box(0.06, 1.3, 0.05, 0, 1.55, -HALF + WALL_THICKNESS / 2)]), part("glass", [box(1.2, 1.3, 0.04, 0, 1.55, -HALF + WALL_THICKNESS / 2)])] },
    { id: "window-round", name: "g.build.item.window-round", icon: "⭕", category: "openings", slot: "edge", layer: "floor", blocking: true, walkableTop: null, build: () => [...wallWithHole("brick", 1.0, 1.1, 2.1), part("plank", [hoop(0.53, 0.06, 18, 0, 1.6, -HALF + WALL_THICKNESS / 2), box(1.04, 0.05, 0.06, 0, 1.6, -HALF + WALL_THICKNESS / 2)]), part("glass", [disc(0.5, 0.06, 18, 0, 1.6, -HALF + WALL_THICKNESS / 2)])] },

    { id: "roof-slope", name: "g.build.item.roof-slope", icon: "🏠", category: "roofing", slot: "tile", layer: "roof", blocking: false, walkableTop: null, build: () => roofSlopeParts("shingle") },
    { id: "roof-clay", name: "g.build.item.roof-clay", icon: "🧡", category: "roofing", slot: "tile", layer: "roof", blocking: false, walkableTop: null, build: () => roofSlopeParts("clay") },
    { id: "roof-thatch", name: "g.build.item.roof-thatch", icon: "🌾", category: "roofing", slot: "tile", layer: "roof", blocking: false, walkableTop: null, build: () => roofSlopeParts("thatch") },
    { id: "roof-ridge", name: "g.build.item.roof-ridge", icon: "⛰️", category: "roofing", slot: "tile", layer: "roof", blocking: false, walkableTop: null, build: () => roofRidgeParts("clay") },
    { id: "roof-gable", name: "g.build.item.roof-gable", icon: "🔺", category: "roofing", slot: "edge", layer: "roof", blocking: false, walkableTop: null, build: () => roofGableParts("plaster") },
    { id: "roof-flat", name: "g.build.item.roof-flat", icon: "▪️", category: "roofing", slot: "tile", layer: "roof", blocking: false, walkableTop: null, build: () => slab("concrete", 0.18, 0) },

    { id: "road", name: "g.build.item.road", icon: "🛣️", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: () => roadParts("none") },
    { id: "road-line", name: "g.build.item.road-line", icon: "🚏", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: () => roadParts("dashed") },
    { id: "road-double", name: "g.build.item.road-double", icon: "🛤️", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: () => roadParts("double") },
    { id: "road-edge", name: "g.build.item.road-edge", icon: "🚧", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: roadEdgeParts },
    { id: "road-crossing", name: "g.build.item.road-crossing", icon: "🦓", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: crossingParts },
    { id: "road-manhole", name: "g.build.item.road-manhole", icon: "⚫", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.1, build: manholeParts },
    { id: "curb", name: "g.build.item.curb", icon: "🧱", category: "outdoor", slot: "edge", layer: "ground", blocking: false, walkableTop: null, build: curbParts },
    { id: "path-stone", name: "g.build.item.path-stone", icon: "🪨", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.08, build: () => slab("cobble", 0.08, 0) },
    { id: "path-concrete", name: "g.build.item.path-concrete", icon: "🚶", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.09, build: () => pavedSlab("concrete", 0.07, "gravel") },
    { id: "path-gravel", name: "g.build.item.path-gravel", icon: "◻️", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.08, build: gravelPathParts },
    { id: "path-marble", name: "g.build.item.path-marble", icon: "🀫", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.09, build: () => pavedSlab("marble", 0.07, "concrete") },
    { id: "path-plank", name: "g.build.item.path-plank", icon: "🪵", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.09, build: boardwalkParts },
    { id: "path-step", name: "g.build.item.path-step", icon: "🐾", category: "outdoor", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.09, build: steppingStonesParts },
    { id: "fence-wood", name: "g.build.item.fence-wood", icon: "🚧", category: "outdoor", slot: "edge", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.2, build: () => fenceParts("plank") },
    { id: "fence-metal", name: "g.build.item.fence-metal", icon: "⛓️", category: "outdoor", slot: "edge", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.2, build: () => fenceParts("metal") },
    { id: "bench", name: "g.build.item.bench", icon: "🪑", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.5, build: benchParts },
    { id: "trash-bin", name: "g.build.item.trash-bin", icon: "🗑️", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.95, blockRadius: 0.34, build: trashBinParts },
    { id: "bollard", name: "g.build.item.bollard", icon: "📍", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.0, blockRadius: 0.2, build: bollardParts },
    { id: "hydrant", name: "g.build.item.hydrant", icon: "🚒", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.8, blockRadius: 0.24, build: hydrantParts },
    { id: "street-sign", name: "g.build.item.street-sign", icon: "🚸", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.3, blockRadius: 0.16, build: streetSignParts },
    { id: "planter", name: "g.build.item.planter", icon: "🌺", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.7, build: planterParts },

    { id: "lawn", name: "g.build.item.lawn", icon: "🟩", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.08, build: lawnParts },
    { id: "soil-bed", name: "g.build.item.soil-bed", icon: "🟤", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.08, build: () => slab("soil", 0.08, 0) },
    { id: "flowerbed-rose", name: "g.build.item.flowerbed-rose", icon: "🌹", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.2, build: () => flowerBedParts("petalRose") },
    { id: "flowerbed-gold", name: "g.build.item.flowerbed-gold", icon: "🌼", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.2, build: () => flowerBedParts("petalGold") },
    { id: "flowerbed-violet", name: "g.build.item.flowerbed-violet", icon: "🪻", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.2, build: () => flowerBedParts("petalViolet") },
    { id: "flowerbed-white", name: "g.build.item.flowerbed-white", icon: "🤍", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.2, build: () => flowerBedParts("petalWhite") },
    { id: "veg-bed", name: "g.build.item.veg-bed", icon: "🥬", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.18, build: vegetableBedParts },
    { id: "flowers-rose", name: "g.build.item.flowers-rose", icon: "🌷", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: () => flowerClusterParts("petalRose") },
    { id: "flowers-gold", name: "g.build.item.flowers-gold", icon: "🌸", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: () => flowerClusterParts("petalGold") },
    { id: "flowers-violet", name: "g.build.item.flowers-violet", icon: "💐", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: () => flowerClusterParts("petalViolet") },
    { id: "flowers-white", name: "g.build.item.flowers-white", icon: "🕊️", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: () => flowerClusterParts("petalWhite") },
    { id: "sunflowers", name: "g.build.item.sunflowers", icon: "🌻", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: sunflowerParts },
    { id: "bush", name: "g.build.item.bush", icon: "🌿", category: "garden", slot: "object", layer: "floor", blocking: false, walkableTop: null, build: bushParts },
    { id: "topiary", name: "g.build.item.topiary", icon: "🎄", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.6, blockRadius: 0.4, build: topiaryParts },
    { id: "hedge", name: "g.build.item.hedge", icon: "🍀", category: "garden", slot: "edge", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.15, build: hedgeParts },
    { id: "garden-arch", name: "g.build.item.garden-arch", icon: "🌸", category: "garden", slot: "edge", layer: "floor", blocking: true, walkableTop: null, opening: { width: 1.4, bottom: 0, top: 2.3 }, blockHeight: 2.6, build: gardenArchParts },
    { id: "tree-oak", name: "g.build.item.tree-oak", icon: "🌳", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.4, blockRadius: 0.4, build: oakParts },
    { id: "tree-maple", name: "g.build.item.tree-maple", icon: "🍁", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.2, blockRadius: 0.36, build: mapleParts },
    { id: "tree-pine", name: "g.build.item.tree-pine", icon: "🌲", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.2, blockRadius: 0.34, build: pineParts },
    { id: "tree-birch", name: "g.build.item.tree-birch", icon: "🎋", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.6, blockRadius: 0.28, build: birchParts },
    { id: "tree-palm", name: "g.build.item.tree-palm", icon: "🌴", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 3.4, blockRadius: 0.3, build: palmParts },
    { id: "rock", name: "g.build.item.rock", icon: "🗿", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.8, build: rockParts },
    { id: "pond", name: "g.build.item.pond", icon: "💧", category: "garden", slot: "tile", layer: "ground", blocking: false, walkableTop: 0.16, build: pondParts },
    { id: "fountain", name: "g.build.item.fountain", icon: "⛲", category: "garden", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.7, blockRadius: 1.0, build: fountainParts },

    { id: "street-lamp", name: "g.build.item.street-lamp", icon: "🏮", category: "lighting", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 3.9, blockRadius: 0.25, light: { color: 0xffdba8, intensity: 30, distance: 18, x: 0, y: 3.4, z: -0.56, nightOnly: true }, build: streetLampParts },
    { id: "classic-lamp", name: "g.build.item.classic-lamp", icon: "🕯️", category: "lighting", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 3.6, blockRadius: 0.25, light: { color: 0xffd7a0, intensity: 24, distance: 15, x: 0, y: 3.28, z: 0, nightOnly: true }, build: classicLampParts },
    { id: "garden-lamp", name: "g.build.item.garden-lamp", icon: "🔦", category: "lighting", slot: "object", layer: "floor", blocking: false, walkableTop: null, light: { color: 0xffd08a, intensity: 11, distance: 9, x: 0, y: 1.14, z: 0 }, build: gardenLampParts },
    { id: "wall-lamp", name: "g.build.item.wall-lamp", icon: "💡", category: "lighting", slot: "edge", layer: "floor", blocking: false, walkableTop: null, attachesToWall: true, light: { color: 0xffe0b0, intensity: 9, distance: 9, x: 0, y: 2.14, z: -HALF + WALL_THICKNESS + 0.34 }, build: wallLampParts },
    { id: "torch", name: "g.build.item.torch", icon: "🔥", category: "lighting", slot: "edge", layer: "floor", blocking: false, walkableTop: null, attachesToWall: true, light: { color: 0xff9a4a, intensity: 12, distance: 10, x: 0, y: 2.5, z: -HALF + WALL_THICKNESS + 0.19, flicker: 0.28 }, build: torchParts },
    { id: "campfire", name: "g.build.item.campfire", icon: "🔥", category: "lighting", slot: "object", layer: "floor", blocking: false, walkableTop: null, light: { color: 0xff8a3c, intensity: 16, distance: 12, x: 0, y: 0.7, z: 0, flicker: 0.35 }, build: campfireParts },
    { id: "chandelier", name: "g.build.item.chandelier", icon: "✨", category: "lighting", slot: "object", layer: "ceiling", blocking: false, walkableTop: null, light: { color: 0xfff0cf, intensity: 16, distance: 12, x: 0, y: LEVEL_HEIGHT - 0.85, z: 0 }, build: chandelierParts },
    { id: "lamp", name: "g.build.item.lamp", icon: "🛋️", category: "lighting", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.2, blockRadius: 0.3, light: { color: 0xffe4bc, intensity: 11, distance: 10, x: 0, y: 1.98, z: 0 }, build: floorLampParts },

    { id: "chair", name: "g.build.item.chair", icon: "🪑", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.6, build: chairParts },
    { id: "table", name: "g.build.item.table", icon: "🍽️", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.9, build: tableParts },
    { id: "bed", name: "g.build.item.bed", icon: "🛏️", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.7, build: bedParts },
    { id: "sofa", name: "g.build.item.sofa", icon: "🛋️", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 0.9, build: sofaParts },
    { id: "shelf", name: "g.build.item.shelf", icon: "📚", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, build: shelfParts },
    { id: "plant", name: "g.build.item.plant", icon: "🪴", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.4, blockRadius: 0.36, build: plantParts },

    { id: "poster", name: "g.build.item.poster", icon: "🖼️", category: "decor", slot: "edge", layer: "floor", blocking: false, walkableTop: null, attachesToWall: true, paint: { width: 1.3, height: 0.9, y: 1.7, z: -HALF + WALL_THICKNESS + 0.055 }, build: () => posterParts(1.3, 0.9, 1.7) },
    { id: "poster-tall", name: "g.build.item.poster-tall", icon: "🖌️", category: "decor", slot: "edge", layer: "floor", blocking: false, walkableTop: null, attachesToWall: true, paint: { width: 0.9, height: 1.4, y: 1.6, z: -HALF + WALL_THICKNESS + 0.055 }, build: () => posterParts(0.9, 1.4, 1.6) },
    { id: "poster-wide", name: "g.build.item.poster-wide", icon: "🎨", category: "decor", slot: "edge", layer: "floor", blocking: false, walkableTop: null, attachesToWall: true, paint: { width: 1.76, height: 0.86, y: 1.75, z: -HALF + WALL_THICKNESS + 0.055 }, build: () => posterParts(1.76, 0.86, 1.75) },
    { id: "billboard", name: "g.build.item.billboard", icon: "📋", category: "decor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.4, paint: { width: 1.7, height: 1.26, y: 1.7, z: 0.045 }, build: billboardParts },

    { id: SPAWN_BEACON_PIECE, name: "g.build.item.spawn-beacon", icon: "🌟", category: "decor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 2.4, blockRadius: 0.5, light: { color: 0x8ad4ff, intensity: 14, distance: 13, x: 0, y: 2.05, z: 0 }, interact: { id: SPAWN_BEACON_INTERACTION, y: 1.4 }, build: spawnBeaconParts },
    { id: STORAGE_CRATE_PIECE, name: "g.build.item.storage-crate", icon: "📦", category: "furniture", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.05, blockRadius: 0.68, interact: { id: STORAGE_INTERACTION, keyed: true, y: 0.9 }, build: storageCrateParts },
    { id: FACTION_TURRET_PIECE, name: "g.build.item.faction-turret", icon: "🔫", category: "outdoor", slot: "object", layer: "floor", blocking: true, walkableTop: null, blockHeight: 1.9, blockRadius: 0.62, light: { color: 0xff5a48, intensity: 5, distance: 7, x: 0, y: 1.72, z: 0 }, build: factionTurretParts },
];

export const LIMITED_BUILD_PIECES = {
    beacon: SPAWN_BEACON_PIECE,
    storage: STORAGE_CRATE_PIECE,
    turret: FACTION_TURRET_PIECE,
} as const;
